...
const Home = () => {
  return (
    <div className="relative flex flex-col md:mt-24 lg:mt-0 py-16 lg:pt-0 lg:flex-col lg:pb-0">
      <div className="inset-y-0 top-0 right-0 z-0 w-full max-w-xl px-4 mx-auto md:px-0 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-7/12 lg:max-w-full lg:absolute xl:px-0">
        ...
        <img
          ...
          src="https://images.squarespace-cdn.com/content/v1/538acfa1e4b01f1c805e1329/1613598775068-Z4Y3LKMYU9QOR1ER5XHZ/junzi+family+meal_Photography+by+Mischelle+Moy_s.jpeg?format=2500w"
          alt=""
        />
      </div>
      <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
        <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          ...
          <h2 className="mb-5 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
            ...
            Can Eat{" "}
            <span className="inline-block text-purple-600">is Delicious</span>
          </h2>
